        ...
        <div className="mobile-card-list">
          ...
          <article key={user.id} className="summary-item compact-card">
            ...
            <div className="action-grid">
              ...
              <button type="button" className="button-primary" onClick={() => saveFinancialPermissions(user, ['RPC_MARKET_TRADE','COMPANY_MARKET_TRADE','PROJECT_CREATE','WITHDRAWAL_REQUEST'])}>Conceder permissões financeiras</button>
              {user.isBlocked ? (
